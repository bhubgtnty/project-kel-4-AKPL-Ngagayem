...
Config::$serverKey = 'SB-Mid-server-xtO6lBfgpfWZWvzkmReb_W3q';
Config::$clientKey = 'SB-Mid-client-yIYmyGNLCJ4p36Jx';
...
include "../../../koneksi.php";
$order_id = $_GET['id_pembelian_barusan'];

  // Query untuk menampilkan data siswa berdasarkan NIS yang dikirim
  $query = "SELECT * FROM pembelian WHERE id_pembelian='".$order_id."'";
